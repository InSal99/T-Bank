                ...
                ?>
                    <div class="col-lg-4 col-sm-6">
                        <div class="feature_item">
                            <div class="f_icon">
                                <?php echo '<img src="../admin-page/pict/'.$content['WastePict'].'" height="150px;" alt="Image">'?>
                            </div>
                            <h4><?php echo $content['WasteName']; ?></h4>
                            <h6><?php echo $content['WasteDesc']; ?> </h6>
                            <h4><?php echo $content['WastePrice']; ?>/KG</h4>
                            <a href="insertcart.php?id=<?php echo $content['WasteId'];?>" class="more_btn">Masukkan Keranjang</a>
                        </div>
                    </div>
                    <?php
                        }
