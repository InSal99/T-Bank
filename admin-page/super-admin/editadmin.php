        ...
        <section class="section">
          <div class="section-body">
            <section class="section">
              ...
              include 'koneksi.php';
              $autoincreament = 1;
              $admin = mysqli_query($conn, "SELECT * FROM admin WHERE AdminId ='" . $AdminId . "'");
              $content = mysqli_fetch_array($admin);
              ?>
              <form method="POST" action="submitadmin.php">
                <input type="hidden" name="id" value="<?= $content['AdminId']; ?>">
                <div class="card-body">
                  <div class="form-group">
                    <label>AdminId</label>
                    <input type="text" class="form-control" name="AdminId" value="<?= $content['AdminId']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="inputPassword5">Password</label>
                    <input type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock" name="AdminPassword" value="<?= $content['AdminPassword']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Nama</label>
                    <input type="text" class="form-control" name="AdminName" value="<?= $content['AdminName']; ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="AdminPhone" value="<?= $content['AdminPhone']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                    <input type="email" class="form-control" name="AdminEmail" value="<?= $content['AdminEmail']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Role</label>
                  ...
                  <div class="text-right">
                    <button class="btn btn-primary mr-1" type="submit" name="updateadmin">Submit</button>
                  </div>
                </div>
              </form>
