    ...
    <div class="main-wrapper">
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Waste</div>
            </div>
          </div>
            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <a href="insertwaste.php" type="button" class="btn btn-primary">Tambah Data</a>
                  </div>
                  <div class="card-body p-0">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-md">
                        ...
                        include 'koneksi.php';
                        $autoincreament = 1;
                        $waste = mysqli_query($conn, "SELECT * FROM waste ORDER BY WasteId");

                        while($content = mysqli_fetch_array($waste)) {
                        ?>
                        <tr>
                          <th><?php echo $autoincreament++; ?></th>
                          <th><?php echo $content['WasteId']; ?></th>
                          <th><?php echo $content['WasteName']; ?></th>
                          <th><?php echo $content['WasteTypeId']; ?></th>
                          <th>Rp. <?php echo $content['WastePrice']; ?>/KG</th>
                          <th><?php echo $content['WasteDesc']; ?></th>
                          <th><?php echo '<img src="../pict/'.$content['WastePict'].'" height="50px;" alt="Image">'?></th>
                          <th>
                              <a href="editwaste.php?id=<?= $content['WasteId'] ?>" class="badge badge-success">Edit</a>
                              <a href="submitwaste.php?id=<?= $content['WasteId'] ?>" class="badge badge-danger">Delete</a>
                          </th>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> T-Bank Admin Page 
        </div>
      </footer>
    </div>
  </div>
