            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <a href="insertcourier.php" type="button" class="btn btn-primary">Tambah Data</a>
                  </div>
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-striped table-md">
                        ...
                        include 'koneksi.php';
                        $autoincreament = 1;
                        $courier = mysqli_query($conn, "SELECT * FROM courier");

                        while($content = mysqli_fetch_array($courier)) {
                        ?>
                        <tr>
                          <th><?php echo $autoincreament++; ?></th>
                          <th><?php echo $content['LicensePlate']; ?></th>
                          <th><?php echo $content['CourierPassword']; ?></th>
                          <th><?php echo $content['CourierName']; ?></th>
                          <th><?php echo $content['CourierGender']; ?></th>
                          <th><?php echo $content['CourierPhone']; ?></th>
                          <th><?php echo $content['CourierEmail']; ?></th>
                          <th>
                              <a href="editcourier.php?id=<?= $content['LicensePlate'] ?>" class="badge badge-success">Edit</a>
                              <a href="submitcourier.php?id=<?= $content['LicensePlate'] ?>" class="badge badge-danger">Delete</a>
                          </th>
