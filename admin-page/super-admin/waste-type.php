          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="nav-link" href="waste-type.php">Kategori Sampah</a></li>
                </ul>
              </li>
            </ul>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Kategori Sampah</div>
            </div>
          </div>
            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <a href="insertwastetype.php" type="button" class="btn btn-primary">Tambah Data</a>
                  </div>
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-striped table-md">
                        ...
                        include 'koneksi.php';
                        $autoincreament = 1;
                        $wastetype = mysqli_query($conn, "SELECT * FROM wastetype ORDER BY WasteTypeId");

                        while($content = mysqli_fetch_array($wastetype)) {
                        ?>
                        <tr>
                          <th><?php echo $autoincreament++; ?></th>
                          <th><?php echo $content['WasteTypeId']; ?></th>
                          <th><?php echo $content['WasteTypeName']; ?></th>
                          <th><?php echo $content['WasteTypeDesc']; ?></th>
                          <th><?php echo $content['WasteTypePict']; ?></th>
                          <th>
                              <a href="editwastetype.php?id=<?= $content['WasteTypeId'] ?>" class="badge badge-success">Edit</a>
                              <a href="submitwastetype.php?id=<?= $content['WasteTypeId'] ?>" class="badge badge-danger">Delete</a>
                          </th>
