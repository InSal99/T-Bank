    ...
    <div class="main-wrapper">
      ...
      <div class="main-content">
        <section class="section">
          ...
          <form method="POST" action="submitwastetype.php" enctype="multipart/form-data">
          <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="WasteTypeName">
                    </div>
                    <div class="form-group">
                      <label>Deskripsi</label>
                      <input type="text" class="form-control" name="WasteTypeDesc">
                    </div>
                    <div class="form-group">
                        <label>Gambar</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="WasteTypePict">
                            <label class="custom-file-label" for="customFile">Choose file</label>
                        </div>
                    </div>
                    <div class="text-right">
                    <button class="btn btn-primary mr-1" type="submit" name="insertwastetype">Submit</button>
                  </div>
              </div>
              </form>
