        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Bank Sampah</div>
            </div>
          </div>
            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <a href="insertwastebank.php" type="button" class="btn btn-primary">Tambah Data</a>
                  </div>
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-striped table-md">
                        ...
                        include 'koneksi.php';
                        $autoincreament = 1;
                        $wastebank = mysqli_query($conn, "SELECT * FROM wastebank ORDER BY WasteBankId");

                        while($content = mysqli_fetch_array($wastebank)) {
                        ?>
                        <tr>
                          <th><?php echo $autoincreament++; ?></th>
                          <th><?php echo $content['WasteBankId']; ?></th>
                          <th><?php echo $content['WasteBankName']; ?></th>
                          <th><?php echo $content['WasteBankLocation']; ?></th>
                          <th><?php echo $content['WasteBankContact']; ?></th>
                          <th><?php echo $content['WasteBankDesc']; ?></th>
                          <th>
                              <a href="editwastebank.php?id=<?= $content['WasteBankId'] ?>" class="badge badge-success">Edit</a>
                              <a href="submitwastebank.php?id=<?= $content['WasteBankId'] ?>" class="badge badge-danger">Delete</a>
                          </th>
