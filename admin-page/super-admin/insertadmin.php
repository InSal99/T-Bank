        ...
        <section class="section">
          ...
          <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock" name="AdminPassword">
                    </div>
                    <div class="form-group">
                      <label>Nama</label>
                  ...
                  <div class="text-right">
                    <button class="btn btn-primary mr-1" type="submit" name="insertadmin">Submit</button>
                  </div>
              </div>
              </form>
