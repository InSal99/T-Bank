            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <a href="insertcustomer.php" type="button" class="btn btn-primary">Tambah Data</a>
                  </div>
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-striped table-md">
                        ...
                        while($content = mysqli_fetch_array($customer)) {
                        ?>
                        <tr>
                          <th><?php echo $autoincreament++; ?></th>
                          <th><?php echo $content['Username']; ?></th>
                          <th><?php echo $content['CustomerPassword']; ?></th>
                          <th><?php echo $content['CustomerName']; ?></th>
                          <th><?php echo $content['CustomerGender']; ?></th>
                          <th><?php echo $content['CustomerPhone']; ?></th>
                          <th><?php echo $content['CustomerEmail']; ?></th>
                          <th><?php echo $content['CustomerAddress']; ?></th>
                          <th>
                            <a href="editcustomer.php?id=<?= $content['Username'] ?>" class="badge badge-success">Edit</a>
                            <a href="submitcustomer.php?id=<?= $content['Username'] ?>" class="badge badge-danger">Delete</a>
                          </th>
