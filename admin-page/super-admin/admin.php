            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <a href="insertadmin.php" type="button" class="btn btn-primary">Tambah Data</a>
                  </div>
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-striped table-md">
                        ...
                        include 'koneksi.php';
                        $autoincreament = 1;
                        $admin = mysqli_query($conn, "SELECT * FROM admin ORDER BY AdminId");

                        while($content = mysqli_fetch_array($admin)) {
                        ?>
                        <tr>
                          <th><?php echo $autoincreament++; ?></th>
                          <th><?php echo $content['AdminId']; ?></th>
                          <th><?php echo $content['AdminPassword']; ?></th>
                          <th><?php echo $content['AdminName']; ?></th>
                          <th><?php echo $content['AdminGender']; ?></th>
                          <th><?php echo $content['AdminPhone']; ?></th>
                          <th><?php echo $content['AdminEmail']; ?></th>
                          <th><?php echo $content['AdminRole']; ?></th>
                          <th>
                              <a href="editadmin.php?id=<?= $content['AdminId'] ?>" class="badge badge-success">Edit</a>
                              <a href="submitadmin.php?id=<?= $content['AdminId'] ?>" class="badge badge-danger">Delete</a>
                          </th>
