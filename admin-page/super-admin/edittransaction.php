        ...
        <section class="section">
          <div class="section-body">
            <section class="section">
              ...
              include 'koneksi.php';
              $autoincreament = 1;
              $transaction = mysqli_query($conn, "SELECT * FROM transaction WHERE TransactionId ='" . $TransactionId. "'");
              $content = mysqli_fetch_array($transaction);
              ?>
              <form method="POST" action="submittransaction.php">
                <input type="hidden" name="id" value="<?= $content['TransactionId']; ?>">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ItemTransactionId" value="<?= $content['ItemTransactionId']; ?>">
                  </div>
                  <div class="form-group">
                      <label>Status</label>
                  ...
                  <div class="text-right">
                    <button class="btn btn-primary mr-1" type="submit" name="updatetransaction">Submit</button>
                  </div>
                </div>
              </form>
