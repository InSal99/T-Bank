        ...
        <section class="section">
          <div class="section-body">
            <section class="section">
              ...
              include 'koneksi.php';
              $autoincreament = 1;
              $wastetype = mysqli_query($conn, "SELECT * FROM wastetype WHERE WasteTypeId ='" . $WasteTypeId . "'");
              $content = mysqli_fetch_array($wastetype);
              ?>
              <form method="POST" action="submitwastetype.php">
                <input type="hidden" name="id" value="<?= $content['WasteTypeId']; ?>">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="WasteTypeName" value="<?= $content['WasteTypeName']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Deskripsi</label>
                    <input type="text" class="form-control" name="WasteTypeDesc" value="<?= $content['WasteTypeDesc']; ?>">
                  </div>
                  <div class="form-group">
                        <label>Gambar</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="WasteTypePict" value="<?= $content['WasteTypePict']; ?>">
                            <label class="custom-file-label" for="customFile">Choose file</label>
                        </div>
                    </div>
                  <div class="text-right">
                    <button class="btn btn-primary mr-1" type="submit" name="updatewastetype">Submit</button>
                  </div>
                </div>
              </form>
