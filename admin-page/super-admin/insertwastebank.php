        ...
        <section class="section">
          ...
          <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="WasteBankId">
                    </div>
                    <div class="form-group">
                      <label>Nama Bank Sampah</label>
                      <input type="text" class="form-control" name="WasteBankName">
                    </div>
                    <div class="form-group">
                      <label>Lokasi</label>
                      <input type="text" class="form-control" name="WasteBankLocation">
                    </div>
                    <div class="form-group">
                      <label>Kontak</label>
                      <input type="text" class="form-control" name="WasteBankContact">
                    </div>
                    <div class="form-group">
                      <label>Deskripsi</label>
                      <input type="text" class="form-control" name="WasteBankDesc">
                    </div>
                  <div class="text-right">
                    <button class="btn btn-primary mr-1" type="submit" name="insertwastebank">Submit</button>
                  </div>
            </div>
            </form>
