                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-md">
                        ...
                        <tr>
                          ...
                          <th><a href="update.php?op=update&id=<?php echo $id?>" class="badge badge-success">Edit</a>
                              <a href="courier.php?op=delete&id=<?php echo $id?>" class="badge badge-danger">Delete</a></th>
