...
if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conn, "UPDATE customer ( Username='$Username', CustomerPassword='$CustomerPassword', CustomerName='$CustomerName', CustomerGender='$CustomerGender', CustomerPhone=$CustomerPhone, CustomerEmail='$CustomerEmail')");
    if($result) {
        ...
        <section class="section">
          ...
          <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock" name="CustomerPassword">
