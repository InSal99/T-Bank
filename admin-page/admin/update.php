        ...
        <section class="section">
          ...
          <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock" name="CourierPassword">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="CourierPhone">
                    </div>
                    <div class="form-group">
                      <label>Email</label>
                      <input type="email" class="form-control" name="CourierEmail">
                    </div>
              ...
              <?php
                ...
                if($op == 'edit') {
                    $id=$_GET['id'];
                    $sql="SELECT * FROM courier WHERE LicensePlate='$id'";
                    $result=mysqli_query($conn, $sql);
                    $take=mysqli_fetch_array($result);
                    $LicensePlate = $take['LicensePlate'];
                    $CourierPassword = $take['CourierPassword'];
                    $CourierName = $take['CourierName'];
                    $CourierGender = $take['CourierGender'];
                    $CourierPhone = $take['CourierPhone'];
                    $CourierEmail = $take['CourierEmail'];

                    if($LicensePlate == '') {
                        $php_errormsg = "Data tidak ditemukan";
                    }
                }
                ?>
